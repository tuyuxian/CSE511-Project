...
object HotzoneUtils {
  ...
  def ST_Contains(queryRectangle: String, pointString: String ): Boolean = {
    ...
    val rect_x1 = min(rectangle(0), rectangle(2))
    val rect_y1 = min(rectangle(1),rectangle(3))
    val rect_x2 = max(rectangle(0), rectangle(2))
    val rect_y2 = max(rectangle(1),rectangle(3))
